...
//#define LED_Pin  13        //背光控制引脚

#define LCD_H      128 
#define LCD_W      160
#define TFT_LCD_RST         GPIO_Pin_12
#define RST_Pin  12       //复位引脚
#define TFT_LCD_DC          GPIO_Pin_14
#define CS_Pin   15       //片选引脚
#define TFT_LCD_CS          GPIO_Pin_15
#define RS_Pin   14       //寄存器/数据选择引脚  
#define TFT_LCD_PORT        GPIOB
#define TFT_LCD_SPIx        SPI1
#define TFT_LCD_SCK         GPIO_Pin_3
#define TFT_LCD_MISO        GPIO_Pin_4
#define TFT_LCD_MOSI        GPIO_Pin_5


//QDtech全系列模块采用了三极管控制背光亮灭，用户也可以接PWM调节背光亮度
#define	LCD_LED PBout(LED_Pin) //LCD背光    		 
